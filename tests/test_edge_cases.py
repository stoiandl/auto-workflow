...
from auto_workflow.exceptions import TaskExecutionError, AggregateTaskError, RetryExhaustedError, TimeoutError
...
# ---------- PROCESS EXECUTION ----------
@task(run_in="process")
def proc_add(a:int,b:int)->int: return a+b
...
# ---------- THREAD EXECUTION ----------
@task(run_in="thread")
def thread_mul(a:int,b:int)->int: return a*b
...
@task
def direct_add(a:int,b:int)->int: return a+b
